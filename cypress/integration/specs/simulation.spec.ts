...
describe('Simulator Navigation', () => {
    it('Simulator',() => {
        ...
        //status change
            ...
            vehicle.sendvehicleID("1","BUSfbf02331");
            vehicle.sendvehicleID("2","BUS55705ac1");
            ...
            cy.wait(60000);
            meterValue.sendmetervalue("1","SoC",String(initialSOC+ utils.getRandomInt(25,35)));
            cy.wait(60000);
            meterValue.sendmetervalue("1","SoC",String(initialSOC+ utils.getRandomInt(35,45)));
            cy.wait(60000);
            meterValue.sendmetervalue("1","SoC",String(initialSOC+ utils.getRandomInt(70,90)));
            cy.wait(2000); 
            ...
            cy.wait(60000);
            meterValue.sendmetervalue("2","SoC",String(initialSOC+ utils.getRandomInt(15,25)));
            cy.wait(60000);
            meterValue.sendmetervalue("2","SoC",String(initialSOC+ utils.getRandomInt(35,50)));
            cy.wait(60000);
