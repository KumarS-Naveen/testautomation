export class meterValuepagess {
   ...
   [{"sampledValue":[
    {"context":"Sample.Periodic","format":"Raw","location":"Inlet","measurand":"Voltage","phase":"L3","unit":"V","value":"131"},
    {"context":"Sample.Periodic","format":"Raw","location":"Cable","measurand":"Temperature","unit":"Celsius","value":"32"},
    {"context":"Sample.Periodic","format":"Raw","location":"Outlet","measurand":"Energy.Active.Import.Register","unit":"kWh","value":"30"},
    {"context":"Sample.Periodic","format":"Raw","location":"Outlet","measurand":"Power.Offered","unit":"W","value":"28400"}
      ],
